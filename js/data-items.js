export const ITEM_DATA = [
  ...
  { area: "ハナダシティ周辺・ルート25", items: [
    ...
    { id: "hd02", name: "ふねのチケット",      type: "gift",   note: "ルート25・ビルの家でビルから（ポケモン変身解除の手伝い後）" },
  ...
  { area: "シオンタウン・ポケモンタワー・ルート12", items: [
...
export const OBTAIN_DATA = {
  ...
  "クラブ":     "グッドロッドで釣り（FR限定）",
  "タマタマ":   "サファリゾーン",
  "サワムラー": "グレンのいえ・格闘道場（1体選択）",
  "エビワラー": "グレンのいえ・格闘道場（1体選択）",
  "ベロリンガ": "通信交換・コダック（セキチクシティ）",
  "ドガース":   "グレンじまほら穴（FR限定）",
  "サイホーン": "サファリゾーン（FR限定）",
  "ラッキー":   "サファリゾーン",
  "ガルーラ":   "サファリゾーン",
  "タッツー":   "スーパーロッドで釣り（ルート19等）",
